...
SETUP = {
    ...
    "dev_pull_prompt": {"en": "⚠️ Development mode: Pull latest changes from branch {}? [Y/n] ",
                        "fr": "⚠️ Mode développement : récupérer les derniers changements de la branche {} ? [O/n] "},
    "skipping_update": {"en": "⏭️ Skipping update, keeping current version ({}).",
                        "fr": "⏭️ Mise à jour ignorée, version actuelle conservée ({})."},
    ...
    "interactive_install_prompt": {"en": "⚙️ Do you want to install (I) or abort (A)? [I/A] ",
                                   "fr": "⚙️ Voulez-vous installer (I) ou annuler (A) ? [I/A] "},
    ...
    "screen_spi_info": {"en": "SPI screen selected — Enter the GPIO pin number (BCM) (22, 23, 24).",
                        "fr": "Écran SPI sélectionné — Entrez les numéros de GPIO (BCM) (22, 23, 24)."},
