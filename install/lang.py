...
SETUP = {
    ...
    "found_force_dist": {"en": "\n⚙️ Major update → Do you want to force a reset for olipi-{}: {} ? [Y/n]", 
                       "fr": "\n⚙️ Mise à jour majeur → Voulez vous forcer une réinitialisation pour olipi-{}: {} ? [O/n]"},
    ...
    "create_file": {"en": "⚡ {} does not exist, creating file from {} ...", "fr": "⚡ {} n'existe pas, création du fichier à partir de {} ..."},
    ...
    "theme_user_ok": {"en": "\n🎨 User themes already up to date", "fr": "\n🎨 Thèmes utilisateur déjà à jour"},
