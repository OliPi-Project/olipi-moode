...
SETUP = {
    ...
    "spi_reboot_required": {"en": "⇨ SPI has been enabled. Please reboot your Raspberry Pi and re-run this script.",
                            "fr": "⇨ Le SPI a été activé. Veuillez redémarrer votre Raspberry Pi puis relancer ce script."},
    ...
    "screen_spi_info": {"en": "SPI screen selected — please provide the pin names (e.g. CE0, D23, D24).",
                        "fr": "Écran SPI sélectionné — renseignez les broches (ex. CE0, D23, D24)."},
