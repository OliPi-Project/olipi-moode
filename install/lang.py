...
SETUP = {
    ...
    "spi_devices_detected": {"en": "✅ SPI interfaces detected: {}", "fr": "✅ Interfaces SPI détectés : {}"},
    ...
    "screen_bl_prompt": {"en": "BL pin (backlight) — leave empty and press enter, not supported for now (connect it to 3.3v)",
                         "fr": "Broche BL (backlight) — Laisser vide et appuyer sur entrée, non implémenté pour le moment (branchez la sur 3.3v)"},
