...
SETUP = {
    ...
    "interactive_update_prompt": {"en": "⚙️ An update is available.\n  Perform update [U], complete install (Update + Configuration)[I], or cancel [A]? [U/I/A] ",
                                  "fr": "⚙️ Une version plus récente est disponible.\n  Mettre à jour [U], installation complète (Update + Configuration)[I], ou annuler [A] ? [U/I/A] "},
    ...
    "screen_saved_ok": {"en": "Screen configuration saved. You need to reboot to take changes into account", 
                        "fr": "Configuration de l'écran enregistrée. Vous devrez redémarrer pour prendre les modifications en compte"},
    ...
    "zram_migrating": {"en": "Migrating to systemd-zram-generator...", "fr": "Migration vers systemd-zram-generator..."},
    "zram_installing": {"en": "Installing systemd-zram-generator...", "fr": "Installation de systemd-zram-generator..."},
    "zram_done": {"en": "✅ ZRAM has been configured, reboot required.", "fr": "✅ ZRAM a été configuré, redémarage recommandé."},
