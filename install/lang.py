...
SETUP = {
    ...
    "interactive_update_prompt": {"en": "⚙️ An update is available.\n  Would you like to perform an update (just clone) [U], a complete installation (Clone + Configuration)[I], or cancel [A]? [U/I/A] ",
                                  "fr": "⚙️ Une version plus récente est disponible.\n  Souhaitez-vous effectuer une mise à jour (juste cloner)[U], une installation complète (Clone + Configuration)[I], ou annuler [A] ? [U/I/A] "},
